...
export const mockMeals: MealOption[] = [
  // === Budget (under $3) ===
  { id: "m1", name: "Rice & Beans Classic", ingredients: ["Rice", "Black Beans"], totalCost: 1.20, servings: 2, chefPick: true, tags: ["Chef Pick", "Budget", "SNAP"] },
  { id: "m2", name: "Simple Omelette", ingredients: ["Eggs", "Bell Peppers", "Onions"], totalCost: 1.50, servings: 1, tags: ["Quick", "SNAP", "Budget"] },
  { id: "m3", name: "French Toast", ingredients: ["Bread", "Eggs", "Milk"], totalCost: 1.80, servings: 2, chefPick: true, tags: ["Chef Pick", "Quick", "Budget"] },
  { id: "m4", name: "Tomato & Egg Scramble", ingredients: ["Eggs", "Tomatoes", "Onions", "Bread"], totalCost: 2.20, servings: 2, tags: ["Quick", "SNAP", "Budget"] },
  { id: "m5", name: "Oatmeal with Bananas", ingredients: ["Oatmeal", "Bananas", "Milk"], totalCost: 1.40, servings: 2, tags: ["Quick", "Budget", "SNAP"] },
  { id: "m6", name: "PB&J Sandwich", ingredients: ["Bread", "Peanut Butter"], totalCost: 0.90, servings: 1, tags: ["Quick", "Budget", "SNAP"] },
  { id: "m7", name: "Ramen Veggie Bowl", ingredients: ["Ramen Noodles", "Eggs", "Frozen Mixed Veggies"], totalCost: 1.60, servings: 2, tags: ["Quick", "Budget", "SNAP"] },
  { id: "m8", name: "Mac & Cheese", ingredients: ["Mac & Cheese Box", "Milk", "Butter"], totalCost: 1.50, servings: 2, tags: ["Quick", "Budget", "Comfort Food"] },
  { id: "m9", name: "Bean & Cheese Quesadilla", ingredients: ["Tortillas", "Black Beans", "Cheddar Cheese"], totalCost: 2.10, servings: 2, tags: ["Quick", "SNAP", "Budget"] },
  { id: "m10", name: "Banana Pancakes", ingredients: ["Bananas", "Eggs", "Flour"], totalCost: 1.30, servings: 2, tags: ["Quick", "Budget", "SNAP"] },
  { id: "m11", name: "Corn & Black Bean Salad", ingredients: ["Canned Corn", "Black Beans", "Tomatoes", "Onions"], totalCost: 1.80, servings: 3, tags: ["Vegetarian", "SNAP", "Budget"] },
  { id: "m12", name: "Egg Drop Soup", ingredients: ["Eggs", "Chicken Noodle Soup"], totalCost: 1.70, servings: 2, tags: ["Quick", "Budget", "SNAP"] },

  // === Mid-range ($3-$5) ===
  { id: "m13", name: "Bean & Rice Burrito Bowl", ingredients: ["Black Beans", "Rice", "Tomatoes", "Onions", "Salsa", "Sour Cream"], totalCost: 3.20, servings: 2, chefPick: true, tags: ["Chef Pick", "Vegetarian", "SNAP"] },
  { id: "m14", name: "Black Bean Tacos", ingredients: ["Black Beans", "Tomatoes", "Onions", "Tortillas", "Cheddar Cheese", "Salsa"], totalCost: 3.80, servings: 3, tags: ["Vegetarian", "SNAP", "Quick"] },
  { id: "m15", name: "Egg Fried Rice", ingredients: ["Eggs", "Rice", "Bell Peppers", "Onions", "Soy Sauce"], totalCost: 2.90, servings: 2, tags: ["Vegetarian", "Quick", "SNAP"] },
  { id: "m16", name: "Pasta Primavera", ingredients: ["Pasta", "Tomatoes", "Bell Peppers", "Onions", "Cooking Oil"], totalCost: 3.50, servings: 3, tags: ["Vegetarian", "SNAP"] },
  { id: "m17", name: "Tuna Pasta Salad", ingredients: ["Pasta", "Canned Tuna", "Mayo", "Onions"], totalCost: 3.40, servings: 3, tags: ["High Protein", "SNAP"] },
  { id: "m18", name: "Creamy Pasta Alfredo", ingredients: ["Pasta", "Milk", "Butter", "Cream Cheese"], totalCost: 4.00, servings: 3, tags: ["Comfort Food", "SNAP"] },
  { id: "m19", name: "Spaghetti with Meat Sauce", ingredients: ["Pasta", "Ground Beef", "Pasta Sauce", "Onions"], totalCost: 4.80, servings: 4, chefPick: true, tags: ["Chef Pick", "High Protein", "SNAP"] },
  { id: "m20", name: "Loaded Baked Potato", ingredients: ["Potatoes", "Butter", "Sour Cream", "Cheddar Cheese", "Bacon"], totalCost: 3.50, servings: 2, tags: ["Comfort Food", "SNAP"] },
  { id: "m21", name: "Turkey Taco Bowl", ingredients: ["Ground Turkey", "Rice", "Black Beans", "Salsa", "Cheddar Cheese"], totalCost: 4.90, servings: 3, tags: ["High Protein", "SNAP"] },
  { id: "m22", name: "Grilled Cheese & Tomato Soup", ingredients: ["Bread", "Cheddar Cheese", "Butter", "Canned Soup - Tomato"], totalCost: 3.20, servings: 2, tags: ["Comfort Food", "Quick", "SNAP"] },
  { id: "m23", name: "Tuna Melt", ingredients: ["Bread", "Canned Tuna", "Cheddar Cheese", "Mayo"], totalCost: 3.00, servings: 2, tags: ["Quick", "High Protein", "SNAP"] },
  { id: "m24", name: "Veggie Stir-Fry", ingredients: ["Frozen Mixed Veggies", "Rice", "Soy Sauce", "Cooking Oil"], totalCost: 3.10, servings: 2, tags: ["Vegetarian", "SNAP", "Quick"] },
  { id: "m25", name: "Pork Chop with Potatoes", ingredients: ["Pork Chops", "Potatoes", "Onions", "Cooking Oil"], totalCost: 4.50, servings: 2, tags: ["High Protein", "SNAP"] },
  { id: "m26", name: "BBQ Chicken Rice", ingredients: ["Chicken Breast", "Rice", "BBQ Sauce", "Onions"], totalCost: 4.20, servings: 2, tags: ["High Protein", "SNAP"] },
  { id: "m27", name: "Hot Dog & Beans", ingredients: ["Hot Dogs", "Black Beans", "Onions", "Ketchup", "Mustard"], totalCost: 3.30, servings: 3, tags: ["Quick", "SNAP", "Budget"] },
  { id: "m28", name: "Cheesy Bean Burritos", ingredients: ["Tortillas", "Black Beans", "Cheddar Cheese", "Salsa", "Sour Cream"], totalCost: 3.60, servings: 3, tags: ["Vegetarian", "SNAP"] },

  // === Heartier meals ($5-$8) ===
  { id: "m29", name: "Chicken & Rice Bowl", ingredients: ["Chicken Breast", "Rice", "Black Beans", "Onions", "Bell Peppers"], totalCost: 5.20, servings: 2, tags: ["High Protein", "SNAP"] },
  { id: "m30", name: "Chicken Stir-Fry", ingredients: ["Chicken Breast", "Bell Peppers", "Onions", "Rice", "Soy Sauce"], totalCost: 6.10, servings: 2, tags: ["High Protein", "SNAP"] },
  { id: "m31", name: "Chef's Pantry Soup", ingredients: ["Chicken Breast", "Tomatoes", "Onions", "Black Beans", "Bell Peppers", "Carrots"], totalCost: 4.70, servings: 4, chefPick: true, tags: ["Chef Pick", "High Protein", "SNAP"] },
  { id: "m32", name: "Beef Tacos", ingredients: ["Ground Beef", "Tortillas", "Cheddar Cheese", "Tomatoes", "Onions", "Salsa", "Sour Cream"], totalCost: 6.50, servings: 4, tags: ["High Protein", "SNAP"] },
  { id: "m33", name: "Bacon Cheeseburger Bowl", ingredients: ["Ground Beef", "Bacon", "Cheddar Cheese", "Onions", "Ketchup", "Mustard"], totalCost: 7.20, servings: 3, tags: ["High Protein", "Comfort Food"] },
  { id: "m34", name: "Chicken Quesadilla", ingredients: ["Chicken Breast", "Tortillas", "Cheddar Cheese", "Bell Peppers", "Salsa"], totalCost: 5.80, servings: 3, tags: ["High Protein", "SNAP", "Quick"] },
  { id: "m35", name: "Beef & Potato Skillet", ingredients: ["Ground Beef", "Potatoes", "Onions", "Cheddar Cheese", "Cooking Oil"], totalCost: 5.90, servings: 3, tags: ["High Protein", "Comfort Food", "SNAP"] },
  { id: "m36", name: "Turkey Burger Patties", ingredients: ["Ground Turkey", "Hamburger Buns", "Tomatoes", "Onions", "Ketchup", "Mustard"], totalCost: 5.40, servings: 4, tags: ["High Protein", "SNAP"] },
  { id: "m37", name: "Chicken Thigh & Veggie Bake", ingredients: ["Chicken Thighs", "Potatoes", "Carrots", "Onions", "Cooking Oil"], totalCost: 4.80, servings: 3, chefPick: true, tags: ["Chef Pick", "High Protein", "SNAP"] },
  { id: "m38", name: "Pork Fried Rice", ingredients: ["Pork Chops", "Rice", "Eggs", "Frozen Mixed Veggies", "Soy Sauce"], totalCost: 5.60, servings: 3, tags: ["High Protein", "SNAP"] },
  { id: "m39", name: "Chili Con Carne", ingredients: ["Ground Beef", "Black Beans", "Diced Tomatoes", "Onions", "Bell Peppers", "Hot Sauce"], totalCost: 6.80, servings: 5, chefPick: true, tags: ["Chef Pick", "High Protein", "SNAP", "Comfort Food"] },
  { id: "m40", name: "Chicken Pasta with Sauce", ingredients: ["Chicken Breast", "Pasta", "Pasta Sauce", "Onions"], totalCost: 5.30, servings: 3, tags: ["High Protein", "SNAP"] },
  { id: "m41", name: "Breakfast for Dinner", ingredients: ["Eggs", "Bacon", "Bread", "Butter", "Orange Juice"], totalCost: 5.50, servings: 3, tags: ["Quick", "Comfort Food"] },
  { id: "m42", name: "Cheesy Potato Soup", ingredients: ["Potatoes", "Cheddar Cheese", "Milk", "Butter", "Onions"], totalCost: 4.60, servings: 4, tags: ["Vegetarian", "Comfort Food", "SNAP"] },
  { id: "m43", name: "Spam & Rice", ingredients: ["Spam", "Rice", "Eggs", "Soy Sauce"], totalCost: 4.40, servings: 3, tags: ["Quick", "SNAP", "Budget"] },
  { id: "m44", name: "Chicken Nugget Dinner", ingredients: ["Frozen Chicken Nuggets", "Potatoes", "Ketchup", "BBQ Sauce"], totalCost: 5.20, servings: 4, tags: ["Quick", "SNAP"] },
  { id: "m45", name: "Pizza Night (Frozen)", ingredients: ["Frozen Pizza", "Ranch Dressing"], totalCost: 4.50, servings: 3, tags: ["Quick", "Comfort Food"] },
];
